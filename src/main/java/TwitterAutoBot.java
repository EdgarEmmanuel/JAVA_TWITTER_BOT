...
public class TwitterAutoBot {
    ...
    private static void tweetLines() {
        String line;
        try (
                // adapt this line according to your Operating Sytem
                InputStream fis = new FileInputStream("/home/immanuwel/Documents/ProjectJava/botTwitter/src/main/resources/tweets.txt");
